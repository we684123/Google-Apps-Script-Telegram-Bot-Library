...
function unit_test() {
    ...
    try {
        ...
        logger.info(bot.sendMessage({
            "chat_id": '207014603',
            "text": "*bold *text*_italic *text___underline__~strikethrough~*bold _italic bold ~italic bold strikethrough~ __underline italic bold___ bold*[inline URL](http://www.example.com/)[inline mention of a user](tg://user?id=123456789)`inline fixed-width code``"(__makeTemplateObject(["pre-formatted fixed-width code block"], ["\\\npre-formatted fixed-width code block\\\n"]))(__makeTemplateObject([""], [""]))
        }(__makeTemplateObject([""], [""]))(__makeTemplateObject(["pythonpre-formatted fixed-width code block written in the Python programming language"], ["python\\\npre-formatted fixed-width code block written in the Python programming language\\\n"]))(__makeTemplateObject([""], [""]))(__makeTemplateObject(["\n    })\n    )\n  } catch (error) { logger.error(error) }\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n}\n"], ["\n    })\n    )\n  } catch (error) { logger.error(error) }\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n}\n"]))));
    }
    finally { }
}
